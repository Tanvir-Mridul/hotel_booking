...
'1'
        ...
        ";
            ...
            if (!empty($_FILES['images']['name'][0])) {
                foreach ($_FILES['images']['tmp_name'] as $key => $tmp_name) {
                    ...
                    if ($_FILES['images']['error'][$key] == 0) {
                        ...
                        if (
                            in_array($_FILES['images']['type'][$key], $allowed_types) &&
            ...
            $success_msg = "Room uploaded successfully! ";
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="amenities[]"
                                                value="<?php echo $am['id']; ?>" id="amenity_<?php echo $am['id']; ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="capacity" class="form-control"
                                        value="<?php echo $_POST['capacity'] ?? '2'; ?>" min="1" max="10" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="room_count" class="form-control"
                                        value="<?php echo $_POST['room_count'] ?? '1'; ?>" min="1" max="50" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price_per_night" class="form-control"
                                        value="<?php echo $_POST['price_per_night'] ?? ''; ?>" min="500" step="100"
                                        required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="images[]" class="custom-file-input" id="imageInput" multiple
                                    accept="image/*" required onchange="previewImages(event)">
