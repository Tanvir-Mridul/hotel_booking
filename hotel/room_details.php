                        ...
                        <div class="mb-4">
                            ...
                            <div class="image-slider">
                                <img id="mainImage" src="../uploads/rooms/<?php echo $images[0]['image_url']; ?>"
                                    class="main-image" alt="Room Image" onerror="this.src='../assets/img/default.jpg'">
                                    ...
                                    <div class="thumbnail-container">
                                        <?php foreach ($images as $index => $image): ?>
                                            <img src="../uploads/rooms/<?php echo $image['image_url']; ?>"
                                                ...
                                                alt="Thumbnail <?php echo $index + 1; ?>" onclick="changeImage(this.src)"
